...
namespace GST_Billing.Models
{
    public class SupplierManagement
    {
        ...
        [Remote("IsSupplierCodeExist", "Master", ErrorMessage = "Supplier code already exist", AdditionalFields = "Id")]
        ...
        public string[] SupplierBankDetailsId { get; set; }
        ...
        public void AddwithParameter(SqlCommand Command)
        {
            ...
            if (BankDetails != null)
                Command.Parameters.Add(new SqlParameter("@BankDetails", SqlDbType.Structured)).Value = BankDetails;
            else
                Command.Parameters.Add(new SqlParameter("@BankDetails", SqlDbType.Structured)).Value = null;
        ...
        public DataTable Getsupplier()
        {
            ...
            {
                cmd = new SqlCommand("SupplierManagement", con);
